...
const useScrollLayoutManager = ({ scrollAxis }) => {
  ...
  const setSectionRect = useCallback(
    (sectionId, rect) => {
      setSections((prev) =>
        Object.assign(Object.assign({}, prev), { [sectionId]: rect })
      );
    },
    [setSections]
  );
    ...
    return () => {
      this.subscriptions.forEach((subscription) => {
        ...
        if (subscription.subscriber === subscriber) {
          (_a = subscription.cleanup) === null || _a === void 0
            ? void 0
            : _a.call(subscription);
        }
      });
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      Object.assign({}, otherProps, {
        ref: ref,
        style: Object.assign(
          { scrollBehavior: "smooth", overflow: "auto" },
          style
        ),
      }),
      children
...
Object.assign(Object.assign({}, complex), {
  getAnimatableNone: (v) => {
...
const Springs = ({ keyframes, springConfigs, data, onSprings }) => {
  ...
  const mergedSpringConfigs = Object.assign(
    Object.assign({}, DEFAULT_SPRING_CONFIGS),
    springConfigs
  );
  const springs = {
    translateX: useSpring(
      (_b =
        (_a = animations.translateX) === null || _a === void 0
          ? void 0
          : _a.get(0)) !== null && _b !== void 0
        ? _b
        : "0",
    ...
    translateY: useSpring(
      (_d =
        (_c = animations.translateY) === null || _c === void 0
          ? void 0
          : _c.get(0)) !== null && _d !== void 0
        ? _d
        : "0",
    ...
    translateZ: useSpring(
      (_f =
        (_e = animations.translateZ) === null || _e === void 0
          ? void 0
          : _e.get(0)) !== null && _f !== void 0
        ? _f
        : "0",
    ...
    scale: useSpring(
      (_h =
        (_g = animations.scale) === null || _g === void 0
          ? void 0
          : _g.get(0)) !== null && _h !== void 0
        ? _h
        : "1",
    ...
    scaleX: useSpring(
      (_k =
        (_j = animations.scaleX) === null || _j === void 0
          ? void 0
          : _j.get(0)) !== null && _k !== void 0
        ? _k
        : "1",
    ...
    scaleY: useSpring(
      (_m =
        (_l = animations.scaleY) === null || _l === void 0
          ? void 0
          : _l.get(0)) !== null && _m !== void 0
        ? _m
        : "1",
    ...
    scaleZ: useSpring(
      (_p =
        (_o = animations.scaleZ) === null || _o === void 0
          ? void 0
          : _o.get(0)) !== null && _p !== void 0
        ? _p
        : "1",
    ...
    skewX: useSpring(
      (_r =
        (_q = animations.skewX) === null || _q === void 0
          ? void 0
          : _q.get(0)) !== null && _r !== void 0
        ? _r
        : "0",
    ...
    skewY: useSpring(
      (_t =
        (_s = animations.skewY) === null || _s === void 0
          ? void 0
          : _s.get(0)) !== null && _t !== void 0
        ? _t
        : "0",
    ...
    rotateX: useSpring(
      (_v =
        (_u = animations.rotateX) === null || _u === void 0
          ? void 0
          : _u.get(0)) !== null && _v !== void 0
        ? _v
        : "0",
    ...
    rotateY: useSpring(
      (_x =
        (_w = animations.rotateY) === null || _w === void 0
          ? void 0
          : _w.get(0)) !== null && _x !== void 0
        ? _x
        : "0",
    ...
    rotateZ: useSpring(
      (_z =
        (_y = animations.rotateZ) === null || _y === void 0
          ? void 0
          : _y.get(0)) !== null && _z !== void 0
        ? _z
        : "0",
    ...
    opacity: useSpring(
      (_1 =
        (_0 = animations.opacity) === null || _0 === void 0
          ? void 0
          : _0.get(0)) !== null && _1 !== void 0
        ? _1
        : "1",
  ...
  useEffect(() => {
    const updateSprings = lodash_throttle(
      (scrollOffset) => {
        var _a,
          _b,
          _c,
        ...
        springs.translateX.set(
          (_b =
            (_a = animations.translateX) === null || _a === void 0
              ? void 0
              : _a.get(progress)) !== null && _b !== void 0
            ? _b
            : "0"
        );
        springs.translateY.set(
          (_d =
            (_c = animations.translateY) === null || _c === void 0
              ? void 0
              : _c.get(progress)) !== null && _d !== void 0
            ? _d
            : "0"
        );
        springs.translateZ.set(
          (_f =
            (_e = animations.translateZ) === null || _e === void 0
              ? void 0
              : _e.get(progress)) !== null && _f !== void 0
            ? _f
            : "0"
        );
        springs.scale.set(
          (_h =
            (_g = animations.scale) === null || _g === void 0
              ? void 0
              : _g.get(progress)) !== null && _h !== void 0
            ? _h
            : "1"
        );
        springs.scaleX.set(
          (_k =
            (_j = animations.scaleX) === null || _j === void 0
              ? void 0
              : _j.get(progress)) !== null && _k !== void 0
            ? _k
            : "1"
        );
        springs.scaleY.set(
          (_m =
            (_l = animations.scaleY) === null || _l === void 0
              ? void 0
              : _l.get(progress)) !== null && _m !== void 0
            ? _m
            : "1"
        );
        springs.scaleZ.set(
          (_p =
            (_o = animations.scaleZ) === null || _o === void 0
              ? void 0
              : _o.get(progress)) !== null && _p !== void 0
            ? _p
            : "1"
        );
        springs.skewX.set(
          (_r =
            (_q = animations.skewX) === null || _q === void 0
              ? void 0
              : _q.get(progress)) !== null && _r !== void 0
            ? _r
            : "0"
        );
        springs.skewY.set(
          (_t =
            (_s = animations.skewY) === null || _s === void 0
              ? void 0
              : _s.get(progress)) !== null && _t !== void 0
            ? _t
            : "0"
        );
        springs.rotateX.set(
          (_v =
            (_u = animations.rotateX) === null || _u === void 0
              ? void 0
              : _u.get(progress)) !== null && _v !== void 0
            ? _v
            : "0"
        );
        springs.rotateY.set(
          (_x =
            (_w = animations.rotateY) === null || _w === void 0
              ? void 0
              : _w.get(progress)) !== null && _x !== void 0
            ? _x
            : "0"
        );
        springs.rotateZ.set(
          (_z =
            (_y = animations.rotateZ) === null || _y === void 0
              ? void 0
              : _y.get(progress)) !== null && _z !== void 0
            ? _z
            : "0"
        );
        springs.opacity.set(
          (_1 =
            (_0 = animations.opacity) === null || _0 === void 0
              ? void 0
              : _0.get(progress)) !== null && _1 !== void 0
            ? _1
            : "1"
        );
      },
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      Object.assign({}, otherProps, {
        ...
        style: Object.assign(Object.assign({}, otherProps.style), {
